...
if __name__ == '__main__':
    ...
    parser.add_argument('--objname', type=str, default='bag/banana_gQP_1_tQP_1.ply') # path to the test ply
    parser.add_argument('--ckpt_path', type=str, default='dataset/WPC.pth') # path to the pretrained weights
